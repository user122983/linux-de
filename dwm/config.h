...
static const char *music_player[] = { "st", "-e", "cmus", NULL };

static const char *vol_up[] = { "amixer", "-q", "sset", "Master", "1%+", NULL };
static const char *vol_down[] = { "amixer", "-q", "sset", "Master", "1%-", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          {.v = browser } },
        ...
        { MODKEY,                       XK_a,      spawn,          {.v = music_player } },
        { MODKEY|ShiftMask,             XK_equal,  spawn,          {.v = vol_up } },
	{ MODKEY|ShiftMask,             XK_minus,  spawn,          {.v = vol_down } },
        { MODKEY|ShiftMask,             XK_m,  spawn,          {.v = vol_mute } },
